...
const Model2 = () => {
    ...
    axios.post('http://localhost:8000/preprocess_inference_model2', formData, {
        headers: {
        ...
        getDelatedImage()
        getResizedImage()
        console.log("FastAPI model2 response", response)
        // response.data.data="['A']"
        document.getElementById("ImagelabelModel2").value="Model2 label:" + response.data.data;
        document.getElementById("toTranslate").value= document.getElementById("toTranslate").value + response.data.data[2];
        console.log(response.data.data)
        })      
        .catch(function(response) {
        document.getElementById("ImagelabelModel2").value="cant display file label";
    ...
    <div>
        ...
        <div className='warning'>  
            ...
            <textarea id='ImagelabelModel2' placeholder="Model 2 Label" disabled readOnly></textarea>
        </div>
