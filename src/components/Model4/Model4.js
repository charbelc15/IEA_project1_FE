...
const Model4 = () => {
    ...
    axios.post('http://localhost:8000/infer_with_cnn', formData, {
        headers: {
        ...
        // getDelatedImage()
        // getResizedImage()
        console.log("FastAPI Best of MLP response", response)
        // response.data.data="['H']"
        document.getElementById("ImagelabelModel4").value="CNN label:" + response.data.data;
        // document.getElementById("toTranslate").value= document.getElementById("toTranslate").value + response.data.data[2];
        console.log(response.data.data)
        })      
        .catch(function(response) {
        document.getElementById("ImagelabelModel4").value="cant display file label";
    ...
    // var label = RetrainLabel4.current.value;
    ...
    <div>
        ...
        <div className='warning'>  
            ...
            <textarea id='ImagelabelModel4' placeholder="Best of CNN label" disabled readOnly></textarea>
        </div>
        ...
        {/* <div className='warning'>
            <label>
                Retrain Label:
                <input required ref={RetrainLabel4} id="retrainlabel4" type="text"  />
            </label>
